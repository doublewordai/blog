...
export default function DrafterCrossover() {
  ...
  return (
    <div className="my-6">
      ...
      <div style={{maxWidth: '380px', margin: '0.75rem auto 0'}}>
        <div style={{display: 'flex', justifyContent: 'space-between', fontSize: '0.72rem', marginBottom: '3px', color: theme.mutedForeground}}>
          <span>← MTP cheaper</span>
          <span>DFlash cheaper →</span>
        </div>
        <canvas
          ref={barRef}
          style={{display: 'block', width: '100%', height: '14px', borderRadius: '3px', border: `1px solid ${theme.grid}`}}
        />
        ...
        <div style={{fontSize: '0.72rem', textAlign: 'center', marginTop: '2px', color: theme.mutedForeground}}>
