...
// per GPU so it is comparable across card counts. "Stock vLLM" is upstream main
// without any of the patches in this post: it does not produce output. "After
// bring-up" is the first throughput number once correctness is sorted. "After
// tuning" is the best stable 512/512 run.
...
export default function Mi300xThroughputBars() {
  ...
  return (
    <div className="my-6" style={{position: 'relative', height: '240px', width: '100%'}}>
      <canvas ref={chartRef} />
    </div>
  )
}
